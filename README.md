<p align="center"><a href="https://github.com/Lezjnb/lx-music-mobile-L"><img width="200" src="https://github.com/Lezjnb/lx-music-mobile-L/blob/master/doc/images/icon.png" alt="lx-music logo"></a></p>

<h1 align="center">LX Music 移动版</h1>

<p align="center">
  <a href="https://github.com/Lezjnb/lx-music-mobile-L/releases"><img src="https://img.shields.io/github/release/Lezjnb/lx-music-mobile-L" alt="Release version"></a>
  <a href="https://github.com/Lezjnb/lx-music-mobile-L/actions/workflows/release.yml"><img src="https://github.com/Lezjnb/lx-music-mobile-L/workflows/Build/badge.svg" alt="Build status"></a>
  <a href="https://github.com/Lezjnb/lx-music-mobile-L/actions/workflows/beta-pack.yml"><img src="https://github.com/Lezjnb/lx-music-mobile-L/workflows/Build%20Beta/badge.svg" alt="Build status"></a>
  <a href="https://github.com/facebook/react-native"><img src="https://img.shields.io/github/package-json/dependency-version/Lezjnb/lx-music-mobile-L/react-native/master" alt="React native version"></a>
...
软件变化请查看[更新日志](https://github.com/Lezjnb/lx-music-mobile-L/blob/master/CHANGELOG.md)。

软件下载请查看 [GitHub Releases](https://github.com/Lezjnb/lx-music-mobile-L/releases)。

使用常见问题请参阅[移动版常见问题](https://lyswhut.github.io/lx-music-doc/mobile/faq)。

本分支的发布地址为 [**GitHub Releases**](https://github.com/Lezjnb/lx-music-mobile-L/releases)。
...
本项目基于 [Apache License 2.0](https://github.com/Lezjnb/lx-music-mobile-L/blob/master/LICENSE) 许可证发行，以下协议是对于 Apache License 2.0 的补充，如有冲突，以以下协议为准。
